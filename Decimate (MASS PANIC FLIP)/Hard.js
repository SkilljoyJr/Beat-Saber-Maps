...
let tinyVib = transformArray(vibValues, 0.25*0.2, 1, 1);
let smallVib = transformArray(vibValues, 0.5*0.2, 1, 1);
let fuckingHugeVib = transformArray(vibValues, 1*0.2, 1, 1);

let zoomOutVib3 = transformArray(vibValues, 0.55*0.2, 1, 0.7);
let zoomOutVib2 = transformArray(vibValues, 0.55*0.7*0.2, 1, 0.7);
let zoomOutVib1 = transformArray(vibValues, 0.55*0.7*0.7*0.2, 1, 0.5);

let hornVib8 = transformArray(vibValues, 0.35*0.2, 1, 0.875);
let hornVib7 = transformArray(vibValues, 0.35*0.2, 0.875, 0.75);
let hornVib6 = transformArray(vibValues, 0.35*0.2, 0.75, 0.625);
let hornVib5 = transformArray(vibValues, 0.35*0.2, 0.625, 0.5);
let hornVib4 = transformArray(vibValues, 0.35*0.2, 0.5, 0.375);
let hornVib3 = transformArray(vibValues, 0.35*0.2, 0.375, 0.25);
let hornVib2 = transformArray(vibValues, 0.35*0.2, 0.25, 0.125);
let hornVib1 = transformArray(vibValues, 0.35*0.2, 0.125, 0);

let hornVib8A = transformArray(vibValues, 0.30*0.2, 1, 0.875);
let hornVib7A = transformArray(vibValues, 0.30*0.2, 0.875, 0.75);
let hornVib6A = transformArray(vibValues, 0.30*0.2, 0.75, 0.625);
let hornVib5A = transformArray(vibValues, 0.30*0.2, 0.625, 0.5);
let hornVib4A = transformArray(vibValues, 0.30*0.2, 0.5, 0.375);
let hornVib3A = transformArray(vibValues, 0.30*0.2, 0.375, 0.25);
let hornVib2A = transformArray(vibValues, 0.30*0.2, 0.25, 0.125);
let hornVib1A = transformArray(vibValues, 0.30*0.2, 0.125, 0);

let hornVib8B = transformArray(vibValues, 0.25*0.2, 1, 0.875);
let hornVib7B = transformArray(vibValues, 0.25*0.2, 0.875, 0.75);
let hornVib6B = transformArray(vibValues, 0.25*0.2, 0.75, 0.625);
let hornVib5B = transformArray(vibValues, 0.25*0.2, 0.625, 0.5);
let hornVib4B = transformArray(vibValues, 0.25*0.2, 0.5, 0.375);
let hornVib3B = transformArray(vibValues, 0.25*0.2, 0.375, 0.25);
let hornVib2B = transformArray(vibValues, 0.25*0.2, 0.25, 0.125);
let hornVib1B = transformArray(vibValues, 0.25*0.2, 0.125, 0);

let hornVib8C = transformArray(vibValues, 0.20*0.2, 1, 0.875);
let hornVib7C = transformArray(vibValues, 0.20*0.2, 0.875, 0.75);
let hornVib6C = transformArray(vibValues, 0.20*0.2, 0.75, 0.625);
let hornVib5C = transformArray(vibValues, 0.20*0.2, 0.625, 0.5);
let hornVib4C = transformArray(vibValues, 0.20*0.2, 0.5, 0.375);
let hornVib3C = transformArray(vibValues, 0.20*0.2, 0.375, 0.25);
let hornVib2C = transformArray(vibValues, 0.20*0.2, 0.25, 0.125);
let hornVib1C = transformArray(vibValues, 0.20*0.2, 0.125, 0);
...
customEvents.push({
  ...
  d: {
    track: "Juan",
    duration: 2,
    scale: [[0.7*20,0.7*20,1*20,0],[1.2*0.7*20,1.2*0.7*20,1*20,0.125,"easeOutSine"],[0.7*20,0.7*20,1*20,1,"easeOutSine"]],
    repeat: 3
  }
}); 
...
customEvents.push({
  ...
  d: {
    track: "Juan",
    duration: 2,
    scale: [[1*20,1*20,1*20,0],[1.2*20,1.2*20,1*20,0.125,"easeOutSine"],[1*20,1*20,1*20,1,"easeOutSine"]],
    repeat: 4
  }
}); 
...
customEvents.push({
  ...
  d: {
    track: "Juan",
    duration: 2,
    scale: [[0.6*20,0.6*20,1*20,0],[1.2*0.6*20,1.2*0.6*20,1*20,0.125,"easeOutSine"],[0.6*20,0.6*20,1*20,1,"easeOutSine"]],
    repeat: 3
  }
}); 
...
customEvents.push({
  ...
  d: {
    track: "Juan",
    duration: 2,
    scale: [[0.5*20,0.5*20,1*20,0],[1.2*0.5*20,1.2*0.5*20,1*20,0.125,"easeOutSine"],[1*20,0.5*20,1*20,1,"easeOutSine"]],
    repeat: 3
  }
}); 
...
customEvents.push({
  ...
  d: {
    track: "Juan",
    duration: 2,
    scale: [[0.35*20,0.35*20,1*20,0],[1.2*0.35*20,1.2*0.35*20,1*20,0.125,"easeOutSine"],[1*20,1*20,1*20,1,"easeOutSine"]],
    repeat: 3
  }
}); 
...
customEvents.push({
  ...
  d: {
    ...
    duration: 0.25,
    scale: [[1,1,1,0],[1.5,1.3,1,0.125,"easeInSine"], [1,1,1,1,"easeOutSine"]],
    dissolve: [[1,0],[0.5,0.01,"easeOutSine"],[0.9,0.125,"easeInSine"], [0.5,0.99,"easeOutSine"],[1,1,"easeOutSine"]],
    repeat: 3,
  }
});
...
customEvents.push({
  ...
  d: {
    track: "notes",
    duration: 0.66,
    dissolve: [[1, 0,"easeOutSine"],[0.5, 0.05,"easeOutCirc"],[0.5, 0.45,"easeOutSine"],[1, 0.5,"easeOutSine"]],
    repeat: 1
  }
});
