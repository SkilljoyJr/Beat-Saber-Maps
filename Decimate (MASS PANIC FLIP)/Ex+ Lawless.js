...
let tinyVib = transformArray(vibValues, 0.25, 1, 1);
let smallVib = transformArray(vibValues, 0.5, 1, 1);
let fuckingHugeVib = transformArray(vibValues, 1, 1, 1);

let zoomOutVib3 = transformArray(vibValues, 0.55, 1, 0.7);
let zoomOutVib2 = transformArray(vibValues, 0.55*0.7, 1, 0.7);
let zoomOutVib1 = transformArray(vibValues, 0.55*0.7*0.7, 1, 0.5);

let hornVib8 = transformArray(vibValues, 0.35, 1, 0.875);
let hornVib7 = transformArray(vibValues, 0.35, 0.875, 0.75);
let hornVib6 = transformArray(vibValues, 0.35, 0.75, 0.625);
let hornVib5 = transformArray(vibValues, 0.35, 0.625, 0.5);
let hornVib4 = transformArray(vibValues, 0.35, 0.5, 0.375);
let hornVib3 = transformArray(vibValues, 0.35, 0.375, 0.25);
let hornVib2 = transformArray(vibValues, 0.35, 0.25, 0.125);
let hornVib1 = transformArray(vibValues, 0.35, 0.125, 0);

let hornVib8A = transformArray(vibValues, 0.30, 1, 0.875);
let hornVib7A = transformArray(vibValues, 0.30, 0.875, 0.75);
let hornVib6A = transformArray(vibValues, 0.30, 0.75, 0.625);
let hornVib5A = transformArray(vibValues, 0.30, 0.625, 0.5);
let hornVib4A = transformArray(vibValues, 0.30, 0.5, 0.375);
let hornVib3A = transformArray(vibValues, 0.30, 0.375, 0.25);
let hornVib2A = transformArray(vibValues, 0.30, 0.25, 0.125);
let hornVib1A = transformArray(vibValues, 0.30, 0.125, 0);

let hornVib8B = transformArray(vibValues, 0.25, 1, 0.875);
let hornVib7B = transformArray(vibValues, 0.25, 0.875, 0.75);
let hornVib6B = transformArray(vibValues, 0.25, 0.75, 0.625);
let hornVib5B = transformArray(vibValues, 0.25, 0.625, 0.5);
let hornVib4B = transformArray(vibValues, 0.25, 0.5, 0.375);
let hornVib3B = transformArray(vibValues, 0.25, 0.375, 0.25);
let hornVib2B = transformArray(vibValues, 0.25, 0.25, 0.125);
let hornVib1B = transformArray(vibValues, 0.25, 0.125, 0);

let hornVib8C = transformArray(vibValues, 0.20, 1, 0.875);
let hornVib7C = transformArray(vibValues, 0.20, 0.875, 0.75);
let hornVib6C = transformArray(vibValues, 0.20, 0.75, 0.625);
let hornVib5C = transformArray(vibValues, 0.20, 0.625, 0.5);
let hornVib4C = transformArray(vibValues, 0.20, 0.5, 0.375);
let hornVib3C = transformArray(vibValues, 0.20, 0.375, 0.25);
let hornVib2C = transformArray(vibValues, 0.20, 0.25, 0.125);
let hornVib1C = transformArray(vibValues, 0.20, 0.125, 0);
...
customEvents.push({
  ...
  d: {
    track: "Juan",
    duration: 2,
    scale: [[0.7*20,0.7*20,1*20,0],[1.8*0.7*20,1.8*0.7*20,1*20,0.125,"easeOutSine"],[0.7*20,0.7*20,1*20,1,"easeOutSine"]],
    repeat: 3
  }
}); 
...
customEvents.push({
  ...
  d: {
    track: "Juan",
    duration: 2,
    scale: [[1*20,1*20,1*20,0],[1.8*20,1.8*20,1*20,0.125,"easeOutSine"],[1*20,1*20,1*20,1,"easeOutSine"]],
    repeat: 4
  }
}); 
...
customEvents.push({
  ...
  d: {
    track: "Juan",
    duration: 2,
    scale: [[0.6*20,0.6*20,1*20,0],[1.8*0.6*20,1.8*0.6*20,1*20,0.125,"easeOutSine"],[0.6*20,0.6*20,1*20,1,"easeOutSine"]],
    repeat: 3
  }
}); 
...
customEvents.push({
  ...
  d: {
    track: "Juan",
    duration: 2,
    scale: [[0.5*20,0.5*20,1*20,0],[1.8*0.5*20,1.8*0.5*20,1*20,0.125,"easeOutSine"],[1*20,0.5*20,1*20,1,"easeOutSine"]],
    repeat: 3
  }
}); 
...
customEvents.push({
  ...
  d: {
    track: "Juan",
    duration: 2,
    scale: [[0.35*20,0.35*20,1*20,0],[1.8*0.35*20,1.8*0.35*20,1*20,0.125,"easeOutSine"],[1*20,1*20,1*20,1,"easeOutSine"]],
    repeat: 3
  }
}); 
...
customEvents.push({
  ...
  d: {
    track: "left1",
    duration: 1,
    offsetPosition: [[-3, 0, 0, 0,], [0, 0, 0, 0.45,"easeOutQuint"]],
  }
});
...
customEvents.push({
  ...
  d: {
    track: "left3",
    duration: 1,
    offsetPosition: [[-3, 0, 0, 0,], [0, 0, 0, 0.47,"easeOutQuint"], [0, 0, 0, 1,"easeOutQuint"]],
  }
});
...
customEvents.push({
  ...
  d: {
    track: "right3",
    duration: 1,
    offsetPosition: [[3, 0, 0, 0,], [0, 0, 0, 0.47,"easeOutQuint"]],
  }
});
...
//#region fake drop1Notes

customEvents.push({
  b: 0,
  t: "AnimateTrack",
  d: {
    track: ["fakeChain1","fakeChain2","fakeChain3","fakeChain4"],
    duration: 2,
    dissolve: [[0, 0],[0, 1]],
    dissolveArrow: [[0, 0],[0, 1]],
  }
}); 
...
customEvents.push({
  ...
  t: "AnimateTrack",
  d: {
    track: ["fakeNote1","fakeNote2","fakeNote3","fakeNote4"],
    duration: 2,
    dissolve: [[0, 0],[0, 1]],
    dissolveArrow: [[0, 0],[0, 1]],
  }
...
customEvents.push({
  ...
  t: "AnimateTrack",
  d: {
    track: ["fakeNote1A","fakeNote2A","fakeNote3A","fakeNote4A"],
    duration: 2,
    dissolve: [[0, 0],[0, 1]],
    dissolveArrow: [[0, 0],[0, 1]],
  }
...
filterednotes = notes.filter(n => n.b >= 214.5 && n.b <= 215.5);
filterednotes.forEach(note => {
  let n1 = JSON.parse(JSON.stringify(note));
    n1.b -= 0.025;
    n1.customData.track = "fakeNote1";
    n1.customData.animation = {}
    n1.customData.animation.offsetPosition = [[-3, 6, 10, 0],[-3, 6, 10, 0.43],[0, 0, 0, 0.48]];
    n1.customData.uninteractable = true;
    n1.customData.spawnEffect = false;
      fakeNotes.push(n1);
});
...
filterednotes.forEach(note => {
  let n1 = JSON.parse(JSON.stringify(note));
    n1.b -= 0.025;
    n1.customData.track = "fakeNote2";
    n1.customData.animation = {}
    n1.customData.animation.offsetPosition = [[-6, 2, 10, 0],[-6, 2, 10, 0.43],[0, 0, 0, 0.48]];
    n1.customData.uninteractable = true;
    n1.customData.spawnEffect = false;
      fakeNotes.push(n1);
});
...
filterednotes.forEach(note => {
  let n1 = JSON.parse(JSON.stringify(note));
    n1.b -= 0.025;
    n1.customData.track = "fakeNote3";
    n1.customData.animation = {}
    n1.customData.animation.offsetPosition = [[5, 3, 10, 0],[5, 3, 10, 0.43],[0, 0, 0, 0.48]];
    n1.customData.uninteractable = true;
    n1.customData.spawnEffect = false;
      fakeNotes.push(n1);
});
...
filterednotes.forEach(note => {
  let n1 = JSON.parse(JSON.stringify(note));
    n1.b -= 0.025;
    n1.customData.track = "fakeNote4";
    n1.customData.animation = {}
    n1.customData.animation.offsetPosition = [[3, 5, 10, 0],[3, 5, 10, 0.43],[0, 0, 0, 0.48]];
    n1.customData.uninteractable = true;
    n1.customData.spawnEffect = false;
      fakeNotes.push(n1);
});
...
//chains
filterednotes = burstSliders.filter(n => n.b >= 214.5 && n.b <= 215.5);
filterednotes.forEach(chain => {
  let c1 = JSON.parse(JSON.stringify(chain));
    c1.b -= 0.025;
    c1.customData.track = "fakeChain1";
    c1.customData.animation = {}
    c1.customData.animation.offsetPosition = [[-3, 6, 10, 0],[-3, 6, 10, 0.42],[0, 0, 0, 0.48]];
    c1.customData.uninteractable = true;
    c1.customData.spawnEffect = false;
      fakeBurstSliders.push(c1);
});
...
filterednotes.forEach(chain => {
  let c1 = JSON.parse(JSON.stringify(chain));
    c1.b -= 0.025;
    c1.customData.track = "fakeChain2";
    c1.customData.animation = {}
    c1.customData.animation.offsetPosition = [[-6, 2, 10, 0],[-6, 2, 10, 0.42],[0, 0, 0, 0.48]];
    c1.customData.uninteractable = true;
    c1.customData.spawnEffect = false;
      fakeBurstSliders.push(c1);
});
...
filterednotes.forEach(chain => {
  let c1 = JSON.parse(JSON.stringify(chain));
    c1.b -= 0.025;
    c1.customData.track = "fakeChain3";
    c1.customData.animation = {}
    c1.customData.animation.offsetPosition = [[5, 3, 10, 0],[5, 3, 10, 0.42],[0, 0, 0, 0.48]];
    c1.customData.uninteractable = true;
    c1.customData.spawnEffect = false;
      fakeBurstSliders.push(c1);
});
...
filterednotes.forEach(chain => {
  let c1 = JSON.parse(JSON.stringify(chain));
    c1.b -= 0.025;
    c1.customData.track = "fakeChain4";
    c1.customData.animation = {}
    c1.customData.animation.offsetPosition = [[3, 5, 10, 0],[3, 5, 10, 0.42],[0, 0, 0, 0.48]];
    c1.customData.uninteractable = true;
    c1.customData.spawnEffect = false;
      fakeBurstSliders.push(c1);
});
...
customEvents.push({
  ...
  d: {
    track: ["fakeNote1","fakeNote2","fakeNote3","fakeNote4"],
    duration: 2,
    dissolve: [[0, 0], [0.5, 0.01, "easeOutSine"],[0.7, 0.98, "easeOutSine"],[0, 0.99, "easeInSine"],],
    dissolveArrow: [[0, 0], [1, 0.01, "easeOutSine"],[1, 0.98, "easeOutSine"],[0, 0.99, "easeInSine"],],
    scale: [[1, 1, 1, 0], [4, 3, 1, 0.125,"easeOutSine"],[1, 1, 1, 0.75,"easeOutSine"]],
  }
}); 
...
//#region fakedrop2Notes

filterednotes = notes.filter(n => n.b >= 214.5+32 && n.b <= 215.5+32);
filterednotes.forEach(note => {
  let n1 = JSON.parse(JSON.stringify(note));
    n1.b -= 0.025;
    n1.customData.track = "fakeNote1";
    n1.customData.animation = {}
    n1.customData.animation.offsetPosition = [[-3, 6, 10, 0],[-3, 6, 10, 0.45],[0, 0, 0, 0.49]];
    n1.customData.uninteractable = true;
    n1.customData.spawnEffect = false;
      fakeNotes.push(n1);
});
...
filterednotes.forEach(note => {
  let n1 = JSON.parse(JSON.stringify(note));
    ...
    n1.customData.track = "fakeNote2";
    n1.customData.animation = {}
    n1.customData.animation.offsetPosition = [[-6, 2, 10, 0],[-6, 2, 10, 0.45],[0, 0, 0, 0.49]];
    n1.customData.uninteractable = true;
    n1.customData.spawnEffect = false;
      fakeNotes.push(n1);
});
...
filterednotes.forEach(note => {
  let n1 = JSON.parse(JSON.stringify(note));
    ...
    n1.customData.track = "fakeNote3";
    n1.customData.animation = {}
    n1.customData.animation.offsetPosition = [[5, 3, 10, 0],[5, 3, 10, 0.45],[0, 0, 0, 0.49]];
    n1.customData.uninteractable = true;
    n1.customData.spawnEffect = false;
      fakeNotes.push(n1);
});
...
filterednotes.forEach(note => {
  let n1 = JSON.parse(JSON.stringify(note));
    ...
    n1.customData.track = "fakeNote4";
    n1.customData.animation = {}
    n1.customData.animation.offsetPosition = [[3, 5, 10, 0],[3, 5, 10, 0.45],[0, 0, 0, 0.49]];
    n1.customData.uninteractable = true;
    n1.customData.spawnEffect = false;
      fakeNotes.push(n1);
});
...
//chains
filterednotes = burstSliders.filter(n => n.b >= 214.5+32 && n.b <= 215.5+32);
filterednotes.forEach(chain => {
  let c1 = JSON.parse(JSON.stringify(chain));
    c1.b -= 0.025;
    c1.customData.track = "fakeChain1";
    c1.customData.animation = {}
    c1.customData.animation.offsetPosition = [[-3, 6, 10, 0],[-3, 6, 10, 0.4],[0, 0, 0, 0.49]];
    c1.customData.uninteractable = true;
    c1.customData.spawnEffect = false;
      fakeBurstSliders.push(c1);
});
...
filterednotes.forEach(chain => {
  let c1 = JSON.parse(JSON.stringify(chain));
    ...
    c1.customData.track = "fakeChain2";
    c1.customData.animation = {}
    c1.customData.animation.offsetPosition = [[-6, 2, 10, 0],[-6, 2, 10, 0.4],[0, 0, 0, 0.49]];
    c1.customData.uninteractable = true;
    c1.customData.spawnEffect = false;
      fakeBurstSliders.push(c1);
});
...
filterednotes.forEach(chain => {
  let c1 = JSON.parse(JSON.stringify(chain));
    ...
    c1.customData.track = "fakeChain3";
    c1.customData.animation = {}
    c1.customData.animation.offsetPosition = [[5, 3, 10, 0],[5, 3, 10, 0.4],[0, 0, 0, 0.49]];
    c1.customData.uninteractable = true;
    c1.customData.spawnEffect = false;
      fakeBurstSliders.push(c1);
});
...
filterednotes.forEach(chain => {
  let c1 = JSON.parse(JSON.stringify(chain));
    ...
    c1.customData.track = "fakeChain4";
    c1.customData.animation = {}
    c1.customData.animation.offsetPosition = [[3, 5, 10, 0],[3, 5, 10, 0.4],[0, 0, 0, 0.49]];
    c1.customData.uninteractable = true;
    c1.customData.spawnEffect = false;
      fakeBurstSliders.push(c1);
});
...
customEvents.push({
  ...
  d: {
    ...
    duration: 2,
    dissolve: [[0, 0], [0.5, 0.01, "easeOutSine"],[0.7, 0.98, "easeOutSine"],[0, 0.99, "easeInSine"],],
    dissolveArrow: [[0, 0], [1, 0.01, "easeOutSine"],[1, 0.99, "easeOutSine"],[0, 1, "easeInSine"],],
    scale: [[1, 1, 1, 0], [4, 3, 1, 0.125,"easeOutSine"],[1, 1, 1, 0.75,"easeOutSine"]],
  }
}); 

//#region fakeDrop3Notes


filterednotes = notes.filter(n => n.b >= 279 && n.b <= 285);
filterednotes.forEach(note => {
  let n1 = JSON.parse(JSON.stringify(note));
    n1.b -= 0.025;
    n1.customData.track = "fakeNote1A";
    n1.customData.animation = {}
    n1.customData.uninteractable = true;
    n1.customData.spawnEffect = false;
      fakeNotes.push(n1);
...
filterednotes.forEach(note => {
  let n1 = JSON.parse(JSON.stringify(note));
    n1.b -= 0.025;
    n1.customData.track = "fakeNote2A";
    n1.customData.animation = {}
    n1.customData.uninteractable = true;
    n1.customData.spawnEffect = false;
      fakeNotes.push(n1);
...
filterednotes.forEach(note => {
  let n1 = JSON.parse(JSON.stringify(note));
    n1.b -= 0.025;
    n1.customData.track = "fakeNote3A";
    n1.customData.animation = {}
    n1.customData.uninteractable = true;
    n1.customData.spawnEffect = false;
      fakeNotes.push(n1);
...
filterednotes.forEach(note => {
  let n1 = JSON.parse(JSON.stringify(note));
    n1.b -= 0.025;
    n1.customData.track = "fakeNote4A";
    n1.customData.animation = {}
    n1.customData.uninteractable = true;
    n1.customData.spawnEffect = false;
      fakeNotes.push(n1);
...
customEvents.push({
  ...
  d: {
    track: ["fakeNote1A","fakeNote2A","fakeNote3A","fakeNote4A"],
    duration: 8,
    dissolve: [[.9, 0],[.9, 0.999],[0, 1]],
    dissolveArrow: [[1, 0],[1, 0.999],[0, 1]],
  }
}); 
...
customEvents.push({
  ...
  d: {
    track: "fakeNote1A",
    offsetPosition: [[8, 0, 0, 0], [8, 0, 0, 1]],
    duration: 2,
  }
}); 
...
customEvents.push({
  ...
  d: {
    track: "fakeNote2A",
    offsetPosition: [[4, 0, 0, 0], [4, 0, 0, 1]],
    duration: 2,
  }
}); 
...
filterednotes = notes.filter(n => n.b >= 279+16 && n.b <= 285+16);
filterednotes.forEach(note => {
  let n1 = JSON.parse(JSON.stringify(note));
    n1.b -= 0.025;
    n1.customData.track = "fakeNote1A";
...
filterednotes = notes.filter(n => n.b >= 279+32 && n.b <= 285+32);
filterednotes.forEach(note => {
  let n1 = JSON.parse(JSON.stringify(note));
    n1.b -= 0.025;
    n1.customData.track = "fakeNote1A";
...
filterednotes = notes.filter(n => n.b >= 279+48 && n.b <= 285+48);
filterednotes.forEach(note => {
  let n1 = JSON.parse(JSON.stringify(note));
    n1.b -= 0.025;
    n1.customData.track = "fakeNote1A";
...
customEvents.push({
  ...
  d: {
    track: "notes",
    duration: 2,
    dissolve: [[1, 0], [0.7, 0.0625,"easeOutSine"],[1, 1,"easeInSine"]],
    scale: [[1, 1, 1, 0], [4, 3, 1, 0.125,"easeOutSine"],[1, 1, 1, 0.75,"easeOutSine"]],
    offsetPosition: [[0, 0, 0, 0], [0, 0, 0, 0.125,"easeOutSine"], [0, 0, 5, 0.5,"easeOutSine"],[0, 0, 0, 0.75,"easeOutSine"]],
  }
});
...
customEvents.push({
  ...
  d: {
    ...
    dissolve: [[1, 0], [0.7, 0.0625,"easeOutSine"],[1, 1,"easeInSine"]],
    scale: [[1, 1, 1, 0], [4, 3, 1, 0.125,"easeOutSine"],[1, 1, 1, 0.75,"easeOutSine"]],
    offsetPosition: [[0, 0, 0, 0], [0, 0, 0, 0.125,"easeOutSine"], [0, 0, 5, 0.5,"easeOutSine"],[0, 0, 0, 0.8,"easeOutSine"]],
  }
});
...
customEvents.push({
  ...
  d: {
    track: "notes",
    duration: 4,
    offsetPosition: [[0, 0, 0, 0.025],[0.0, 0.5, 0, 0.05, "easeOutSine"],[0, 0, 0, 0.1, "easeOutSine"],[0, 0, 0, 0.525, "easeOutSine"],[0, 1, 0, 0.55, "easeOutSine"],[0, 0, 0, 0.6, "easeOutSine"]],
    scale: [[1, 1, 1, 0.025],[1.4, 1.2, 1, 0.05, "easeOutSine"],[1, 1, 1, 0.1, "easeOutSine"],[1, 1, 1, 0.525, "easeOutSine"],[1.6, 1.3, 1, 0.55, "easeOutSine"],[1, 1, 1, 0.6, "easeOutSine"]],
    repeat: 31
  }
});
...
customEvents.push({
  ...
  d: {
    track: "notes",
    duration: 32,
    dissolve: [[1, 0,"easeOutSine"],[0.2, 1]],
    dissolveArrow: [[1, 0,"easeOutSine"],[0.4, 1]],
  }
});
...
customEvents.push({
  ...
  d: {
    ...
    dissolveArrow: [[0, 0],[0.75, 0.499],[1, 1, "easeOutSine"]],
    repeat: 14
  }
});
...
customEvents.push({
  ...
  d: {
    track: "everything",
    duration: 1,
    scale: [[0.85,0.85,1,0],[0.9,0.9,1,0.125,"easeInSine"], [0.85,0.85,1,"easeOutSine"]],
    repeat: 6
  }
});
...
customEvents.push({
  ...
  d: {
    track: "everything",
    duration: 1,
    scale: [[0.7,0.7,1,0],[0.75,0.75,1,0.125,"easeInSine"],[0.7,0.7,1,1,"easeOutSine"]],
    repeat: 6
  }
});
...
customEvents.push({
  ...
  d: {
    track: "everything",
    duration: 1,
    scale: [[0.55,0.55,1,0],[0.6,0.6,1,0.125,"easeInSine"],[0.55,0.55,1,1,"easeOutSine"]],
    repeat: 6
  }
});
...
customEvents.push({
  ...
  d: {
    track: "everything",
    duration: 1,
    scale: [[0.4,0.4,1,0],[0.45,0.45,1,0.125,"easeInSine"],[0.4,0.4,1,1,"easeOutSine"]],
    repeat: 5
  }
});
*/
...
customEvents.push({
  ...
  d: {
    track: "everything",
    duration: 2,
    scale: [[1,1,1,0],[1.8,1.8,1,0.125,"easeOutSine"],[1,1,1,1,"easeOutSine"]],
    repeat: 13
  }
}); 
...
customEvents.push({
  ...
  d: {
    track: "everything",
    duration: 2,
    scale: [[0.7,0.7,1,0],[1.1*0.7,1.1*0.7,1,0.125,"easeOutSine"],[0.7,0.7,1,1,"easeOutSine"]],
    repeat: 3
  }
}); 
...
customEvents.push({
  ...
  d: {
    track: "everything",
    duration: 2,
    scale: [[0.6,0.6,1,0],[1.1*0.6,1.1*0.6,1,0.125,"easeOutSine"],[0.6,0.6,1,1,"easeOutSine"]],
    repeat: 3
  }
}); 
...
customEvents.push({
  ...
  d: {
    track: "everything",
    duration: 2,
    scale: [[0.5,0.5,1,0],[1.1*0.5,1.1*0.5,1,0.125,"easeOutSine"],[0.5,0.5,1,1,"easeOutSine"]],
    repeat: 3
  }
}); 
...
customEvents.push({
  ...
  d: {
    track: "everything",
    duration: 2,
    scale: [[0.35,0.35,1,0],[1.1*0.35,1.1*0.35,1,0.125,"easeOutSine"],[0.35,0.35,1,1,"easeOutSine"]],
    repeat: 3
  }
}); 
*/
...
customEvents.push({
  ...
  d: {
    track: "everything",
    duration: 8,
    scale: [[1,1,1,0],[0.4,0.4,1,1,"easeOutSine"]],  }
}); 
